...
const RAW_ROSTER: Wrestler[] = [
  ...
  { id: 'raw_034', name: 'Gunther', brand: RAW, style: POWER, imageUrl: getWrestlerImage('Gunther'), country: 'Austria', heightCm: 193, weightKg: 113, bio: 'Ring General.', stats: { overall: 96, strength: 95, agility: 70, technique: 94, speed: 75, defense: 95, resilience: 98 } },
