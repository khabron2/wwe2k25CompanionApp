...
const RAW_ROSTER: Wrestler[] = [
  ...
  { id: 'raw_062', name: 'Rhea Ripley', brand: RAW, style: STRIKER, imageUrl: 'https://www.wrestlinginc.com/img/gallery/wwes-rhea-ripley-drops-jey-uso-yeet-to-the-delight-of-bash-in-berlin-kickoff-crowd/l-intro-1725046437.jpg', country: 'Australia', heightCm: 171, weightKg: 75, bio: 'Mami.', stats: { overall: 96, strength: 94, agility: 80, technique: 85, speed: 80, defense: 90, resilience: 95 } },
